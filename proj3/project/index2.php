...
<main>
    ...
    $pdo = new PDO("mysql:host=localhost;dbname=test5;charset=utf8","root","");
...
<?php
    ...
    $sth = $db->prepare("SELECT * FROM todos WHERE ownerid=:session ORDER BY id DESC");
    $sth->bindValue(":session", $_SESSION['id']);
    $sth->execute();
